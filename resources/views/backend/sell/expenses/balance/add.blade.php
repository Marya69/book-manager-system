...
@section('title', 'Add Balance Expenses')
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ps-3">
                    <h6 class="mb-0 text-uppercase">Add Balance Expenses</h6>
                </div>
                <div class="ms-auto">
                    <div class="btn-group">
                ...
                <div class="col-xl-8 mx-auto">
                    <div class="row card">
                        <div class="card-body p-4 row">
                            <form action="{{ route('Store.Balance.Expenses') }}" method="post"
                                ...
                                <div class="col-md-12">
                                    <div class="d-md-flex d-grid align-items-center gap-3">
                                        <button type="submit" value="Add Balance Expenses" class="btn btn-primary px-4">Add
